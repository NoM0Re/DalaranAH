-- Localizations Portuguese Client
local L = LibStub("AceLocale-3.0"):NewLocale("DalaranAH", "ptPT")
...
L["Brassbolt Mechawrench"] = "Açofuso Mecachave"                                                              -- Must exactly Match NPC Name
L["Press "] = "Press "
