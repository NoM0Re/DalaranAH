-- Localizations Spanish Client
local L = LibStub("AceLocale-3.0"):NewLocale("DalaranAH", "esMX")
if not L then return end

-- Mandatory that the addon works with ur Language
L["Like Clockwork"] = "Como un reloj"                                                    -- Must exactly Match DalaranAH RealZoneName use in chat: /run local getcurrentZone = tostring(GetMinimapZoneText());print(getcurrentZone)
L["Brassbolt Mechawrench"] = "Pernolatón Mecallave"                                             -- Must exactly Match NPC Name
L["Press "] = "Press "
