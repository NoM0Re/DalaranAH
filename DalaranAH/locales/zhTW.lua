-- Localizations Chinese(traditional) Client
local L = LibStub("AceLocale-3.0"):NewLocale("DalaranAH", "zhTW")
if not L then return end

-- Mandatory that the addon works with ur Language
L["Like Clockwork"] = "精密仪器"                                                    -- Must exactly Match DalaranAH RealZoneName use in chat: /run local getcurrentZone = tostring(GetMinimapZoneText());print(getcurrentZone)
L["Brassbolt Mechawrench"] = "布拉斯博特·机钳"                                             -- Must exactly Match NPC Name
L["Press "] = "Press "
