-- Localizations French Client
local L = LibStub("AceLocale-3.0"):NewLocale("DalaranAH", "frFR")
if not L then return end

-- Mandatory that the addon works with ur Language
L["Like Clockwork"] = "Comme Une Horloge"                                                    -- Must exactly Match DalaranAH RealZoneName use in chat: /run local getcurrentZone = tostring(GetMinimapZoneText());print(getcurrentZone)
L["Brassbolt Mechawrench"] = "Zéboulon Mécaclef"                                             -- Must exactly Match NPC Name
L["Press "] = "Press "
