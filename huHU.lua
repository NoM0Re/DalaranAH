-- Localizations Hungarian Client
local L = LibStub("AceLocale-3.0"):NewLocale("DalaranAH", "huHU")
if not L then return end

-- Mandatory that the addon works with ur Language
L["Like Clockwork"] = "Like Clockwork"                                                    -- Must exactly Match DalaranAH RealZoneName use in chat: /run local getcurrentZone = tostring(GetMinimapZoneText());print(getcurrentZone)
L["Brassbolt Mechawrench"] = "Brassbolt Mechawrench"                                             -- Must exactly Match NPC Name
L["Press "] = "Press "
